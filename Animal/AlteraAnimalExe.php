...
<body>
    ...
    <section>
        <div class="principal">
            ...
            $sql = "";
            if($nome_foto == "")
                $sql = "UPDATE animal SET nome = '$nome', especie = '$especie',
                raca = '$raca', data_nascimento = '$dataNascimentoFormatada',
                castrado = $castrado, id_pessoa = $pessoa WHERE id = $id";
            else
                $sql = "UPDATE animal SET foto = '$nome_foto', nome = '$nome',
                especie = '$especie', raca = '$raca', 
                data_nascimento = '$dataNascimentoFormatada', castrado = $castrado,
                id_pessoa = $pessoa WHERE id = $id";
